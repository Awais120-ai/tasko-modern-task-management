...
export function Reminders() {
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-foreground mb-6">Upcoming Live Class</h2>
      <div className="space-y-4">
        <div className="bg-card border border-border rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
          <h3 className="font-semibold text-foreground mb-1">Advanced React Patterns</h3>
          <p className="text-sm text-muted-foreground mb-1">Instructor: Sarah Mitchell</p>
